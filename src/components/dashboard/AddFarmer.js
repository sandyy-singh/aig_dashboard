    ...
    <div className="container-fluid parent">
      ...
      {showForm && (
        <div className="container-fluid ">
          <div className=" row  d-flex justify-content-center align-items-center addBack  ">
            <h1 className="text-center text-dark p-4">Agroforestry Form</h1>
            <div className="col-11 col-md-11 col-lg-10  rounded border-secondary  p-sm-4 mb-5 shadow secondary11  ">
              <form autoComplete="off" className="form-group ">
                ...
                <div className="row d-flex justify-content-center align-items-center mb-4">
                  ...
                  <div className="col-sm-5 mt-3 ">
                    ...
                    >
                      ...
                      <option value="NGO">NGO (Agri-/ Forestry focused)</option>
                  ...
                  <div className="col-sm-5 mt-3">
                    <label className="labels-1" htmlFor="NumberOfFarmers">
                      Total Number of Farmers (in case of FPO/ Agri-Services/
                      Agri-Supply Chain Company/ NGO)
                    </label>
                    <input
                      type="number"
                      className="form-control form-inputs "
                ...
                <div className="row d-flex justify-content-center align-items-center">
                  ...
                  <div className="col-sm-5 mt-3 ">
                    <label className="labels-1" htmlFor="GeographicCoordinates">
                  ...
                  <div className="col-sm-5 mt-4">
                    <label className="labels-1" htmlFor="ownershipSituation">
                  ...
                  <div className="col-sm-5 mt-2">
                    ...
                    >
                      What documentation can be used to prove legal land rights?
                      Please specify all applicable options
                    </label>
                    <input
                      type="text"
                      className="form-control form-inputs "
                  ...
                  <div className="col-sm-5 mt-3 ">
                    <label className="labels-1" htmlFor="areaCroplandGrassland">
                  ...
                  <div className="col-sm-5 mt-3">
                    <label className="labels-1" htmlFor="objectiveOfProject">
                      What is the objective of the project? Describe briefly.
                    </label>
                    <input
                      type="text"
                      className="form-control form-inputs "
                  ...
                  <div className="col-sm-5 mt-3 ">
                    ...
                    >
                      What would happen on the property if the proposed project
                      were not to be undertaken? Have alternative land uses been
                      pursued? Describe briefly.
                    </label>
                    <input
                      type="text"
                      className="form-control form-inputs "
                  ...
                  <div className="col-sm-5 mt-3">
                    <label htmlFor="Improvedpractice">
                      Are there any improved practice's that will be applied?
                    </label>
                  ...
                  <div className="col-sm-5 mt-3">
                    <label htmlFor="managementOfManure">
                      if the project activity includes improving the management
                      of manure and manure application
                    </label>
                  ...
                  <div className="col-sm-5 mt-3">
                    <label htmlFor="NfixingSpecies">
                      If the area cropped or planted with N-fixing species in
                      the project is more than 50% larger than the area under
                      N-fixing species in the baseline
                    </label>
                  ...
                  {NfixingSpecies && (
                    <div className="col-sm-5 mt-3">
                      <label htmlFor="NfixingSpecies1" className="text-primary">
                  ...
                  <div className="col-sm-5 mt-3 ">
                    <label className="labels-1" htmlFor="farmerName">
                      If the project activity includes the introduction of trees
                      (Plantations or Agroforestry) into the landscape, then
                      report the following parameter: Existing or Baseline
                      Scenario
                      <p>
                        1- Area of agroforestry (acres) 2-Type of agroforestry
                        system (Silvopasture/ Alley Cropping/ Forest Farming/
                        Riparian Forest Buffers/ Windbreaks/Shelterbelts/
                        Others) 3- What is the project start date (or the
                        projected date)? Please indicate month and year [Note:
                        Start Date indicates the date that planting activities
                        began (or are projected to begin)]) 4- Number
                        (trees/acre) and species of tree used 5- Describe the
                        improved management practices for the agroforestry
                        species (incl. harvesting cycles, existing species,
                        threats)
                      </p>
                    </label>
                    <input
                  ...
                  <div className="col-sm-5 mt-3">
                    <label htmlFor="agricultureResidueBurning">
                      If the project activity includes avoidance of agriculture
                      residue burning. Select Yes/No
                    </label>
                    <div id="agricultureResidueBurning">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          name="agricultureResidueBurning"
                          value="NO"
                          onClick={() => setAgricultureResidueBurning(false)}
                        />
                      </div>
                    </div>
                  </div>
                  {agricultureResidueBurning && (
                    <div className="col-sm-5 mt-3">
                      ...
                      <input
                        ...
                        value={formData.avoidanceOfAgricultureResidueBurning}
                        onChange={handleInputChange}
                        required
                      />
                    </div>
                  ...
                  <div className="col-sm-5 mt-3">
                    ...
                    >
                      Is the project located in or have areas with predominantly
                      organic soils* (with a high concentration of organic
                      carbon)?
                    </label>
                    <input
                      type="text"
