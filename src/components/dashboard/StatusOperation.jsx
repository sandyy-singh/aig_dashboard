    ...
    return (
        <div className="container-fluid ">
            <div className="row"> 
                ...
                <div className='col-12  mx-3 mx-xl-0'>
                    <h3 className="fs-4 fw-bold  ms-3 mt">States Under Operation</h3>
                </div>
                <div className='col-12 mt-xl-5 d-flex align-items-center justify-content-center'>
